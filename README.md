...
Retro arcade UI elements (pixel borders, 8-bit fonts, CRT glow)
Planetary and orbit animations (rotating icons, cosmic gradients)
Starfield backgrounds with parallax motion
